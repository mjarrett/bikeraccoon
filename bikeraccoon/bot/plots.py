...
def plot_stations(api,trips,extent=None, palette=None):
    ...
    print(sdf)
    sdf.plot(ax=ax,markersize='trips',color=color,alpha=0.2)
    sdf.plot(ax=ax,markersize=5,color=color,alpha=1,marker='.')
    ...
    labels = ['0', '10', '100']
    ax.legend([l3, l1, l2], labels, title='Station Activity')
